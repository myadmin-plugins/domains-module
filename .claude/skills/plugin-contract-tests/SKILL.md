...
The class under contract here is `Detain\MyAdminDomains\Plugin`.
...
- This package declares `$module = 'domains'`. Changing it detaches the plugin from the events core dispatches to it, so the generated pin asserts it.
